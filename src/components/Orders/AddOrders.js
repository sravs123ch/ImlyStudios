...
// const categories = [
//   { name: 'Walk-in', subOptions: ["Newspaper ad"] },
//   { name: 'Social Media', subOptions: ['Google', 'Facebook', 'Instagram'] },
//   { name: 'Reference', subOptions: ['Existing Client', 'Directors', 'Employee'] },
// ];
// const steps = ['Order Details',  'Order Status', "payments"];
// const typeOptions = [
//   { name: 'Kitchen' },
...
//   { name: '2 BHK' },
//   { name: '3 BHK' },
//   { name: 'Others (TV unit, Crockery, Shoe rack, Vanities)' },
// ];
...
//     setOrderDetails({ ...orderDetails, Type: type.name });
//   };
//   const [selectedStatus, setSelectedStatus] = useState("");

//   const handleStatusChange = (status) => {
//     setSelectedStatus(status);
//     setOrderDetails({ ...orderDetails, OrderStatus: status.name });
//   };
...
//   setOrderDetails({ ...orderDetails, PaymentMethod: method.name });
// };
...
//   setOrderDetails({ ...orderDetails, PaymentStatus: status.name });
// };
...
//           <Combobox.Input
//             className={`w-full mt-2 mb-1 rounded-md border-0 bg-white py-1.5 pl-3 pr-10 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:black sm:text-sm sm:leading-6 ${
...
// <div className="flex">
//   <label className="text-left ml-44 w-1/4 mt-3 text-xs font-medium text-gray-700">Payments Type:</label>
//   <Combobox value={selectedPaymentMethod} onChange={handlePaymentMethodChange}>
//     <div className="relative mt-1 w-1/4">
//       <Combobox.Input
//         className={`w-full p-1 border rounded-md ${
...
// <div className="flex">
//   <label className="text-left ml-44 w-1/4 mt-3 text-xs font-medium text-gray-700">Payment Status:</label>
//   <Combobox value={selectedPaymentStatus} onChange={handlePaymentStatusChange}>
//     <div className="relative mt-1 w-1/4">
//       <Combobox.Input
//         className={`w-full p-1 border rounded-md ${
...
function AddOrders() {
  ...
  const handleAutoFill = () => {
    ...
    setOrderDetails((prevDetails) => {
      // Determine if we should clear the address fields
      const hasNewAddress = Object.keys(addresses).length > 0;
      ...
      const newDetails = {
        ...
        AddressLine1: hasNewAddress ? addresses.AddressLine1 : "",
        AddressLine2: hasNewAddress ? addresses.AddressLine2 : "",
        CityID: hasNewAddress ? addresses.CityID : "",
        StateID: hasNewAddress ? addresses.StateID : "",
        CountryID: hasNewAddress ? addresses.CountryID : "",
        ZipCode: hasNewAddress ? addresses.ZipCode : "",
      ...
      // Log for debugging
      console.log("Auto-filling details:", newDetails);
                      ...
                      <div className="flex justify-left items-center h-full">
                        ...
                        {isDialogOpen && selectedCustomer && (
                          <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                            <div
                              className="bg-white p-8 rounded-2xl shadow-2xl max-w-lg w-full border border-gray-200 relative"
                              data-aos="zoom-in"
                            >
                              ...
                              <div className="absolute top-0 left-0 right-0 bg-gray-600 p-4 rounded-t-2xl border-b border-gray-400 flex items-center justify-between z-10" data-aos="fade-up">
                                {/* Heading and Cancel Button Container */}
                                ...
                                >
                                  <span
                                    className="flex items-center justify-center h-5 w-5 bg-red-600 rounded-full hover:bg-red-700 transition-colors duration-300 text-white text-xs"
                                    data-aos="zoom-in"
                                  >
                                    &#10005; {/* Unicode character for a better-looking 'X' symbol */}
                                  </span>
                                </button>
                              </div>
                              ...
                              <div className="pt-20 space-y-2">
                                <p className="text-gray-800 text-lg leading-tight" data-aos="fade-right">
                                ...
                                <div>
                                  ...
                                  <div className="mt-2 space-y-2">
                                    {selectedCustomer.Addresses.map((address, index) => (
                                      <div
                                        key={index}
                                        className="flex items-center p-4 bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition-all transform hover:scale-105"
                                        data-aos="fade-left"
                                      >
                                        <input
                                          type="radio"
                    ...
                    <div className="grid">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          value={orderDetails.StateID}
                          onChange={handleChange}
                          className={` p-1  mt-2 mb-1 w-full border rounded-md ${errors.StateID
                            ? "border-red-500"
                            : "border-gray-300"
                            }`}
                        />
                      ...
                      <div>
                        ...
                        <input
                          ...
                          value={orderDetails.CountryID}
                          onChange={handleChange}
                          className={` p-1  mt-2 mb-1 w-full border rounded-md ${errors.CountryID
                            ? "border-red-500"
                            : "border-gray-300"
                            }`}
                        />
...
<div className="mt-0">
  ...
  <div className="relative mt-2">
    <Combobox as="div" value={selectedCountry} onChange={handleCountryChange}>
      <div className="relative">
        <Combobox.Input
          className={`w-full p-1 border rounded-md ${errors.CountryID ? "border-red-500" : "border-gray-300"} bg-white pl-3 pr-10 text-gray-900 shadow-sm sm:text-sm`}
          onChange={(event) => setQuery(event.target.value)} 
      ...
      <p className="text-red-500 text-sm mt-1">{errors.CityID}</p>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          value={orderDetails.TotalQuantity}
                          onChange={handleChange}
                          className={` p-1  mt-2 mb-1 w-full border rounded-md ${errors.TotalQuantity
                            ? "border-red-500"
                            : "border-gray-300"
                            }`}
                        />
                    ...
                    <>
                      <div className="flex gap-36 ">
                        ...
                        <input
                          ...
                          value={orderDetails.DesginerName}
                          onChange={handleChange}
                          className={` p-1 w-1/3 border rounded-md ${errors.DesginerName
                            ? "border-red-500"
                            : "border-gray-300"
                            }`}
                        />
                    ...
                    {orders.length >= 0 && (
                      <>
                        <table className="min-w-full border-collapse border border-gray-300 mt-4">
                          <thead className="bg-custom-maroon">
                            <tr className="text-center border-b border-gray-300">
                              <th className="px-4 py-2 font-normal border-r border-gray-300">
                                Order Status
                              </th>
                              <th className="px-4 py-2 font-normal border-r border-gray-300">
                                Assign To
                    ...
                    {orders.length >= 0 && (
                      <>
                        <table className="min-w-full border-collapse border border-gray-300 mt-4">
                          <thead className="bg-custom-maroon">
                            <tr className="text-center border-b border-gray-300">
                              <th className="px-4 py-2 font-normal border-r">
                                Payment Type
                              </th>
                              <th className="px-4 py-2 font-normal border-r border-gray-300">
                                Payments Status
          ...
          {submittedDetails && (
            <div className="mt-4 bg-gray-100 p-4 rounded shadow-lg">
              ...
              <p>
                <strong>Initial Measurement Length:</strong>{" "}
                {submittedDetails.length}
              </p>
              <p>
                <strong>Initial Measurement Height:</strong>{" "}
                {submittedDetails.height}
              </p>
              <p>
                <strong>Initial Measurement Width:</strong>{" "}
                {submittedDetails.width}
              </p>
              <p>
                <strong>Final Measurement Length:</strong>{" "}
                {submittedDetails.finalLength}
              </p>
              <p>
                <strong>Final Measurement Height:</strong>{" "}
                {submittedDetails.finalHeight}
              </p>
              <p>
                <strong>Final Measurement Width:</strong>{" "}
                {submittedDetails.finalWidth}
              </p>
              <div className="grid grid-cols-3 gap-4 mt-4">
