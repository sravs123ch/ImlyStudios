...
//             <Combobox
//               as="div"
//               value={productDetails.selectedsizeType}
//               onChange={(sizeType,e) => {
//                 setQuery('');
//                 setSelectedsizeType(sizeType);
//                 handleProductDetailsChange('sizeType', e.target.value)
//               }}
//             >
//               <div className="relative mt-2">
//                 <ComboboxInput
...
//                 {filteredsizeType.length > 0 && (
//                   <ComboboxOptions className="absolute z-10 mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
//                     {filteredsizeType.map((sizeType) => (
//                       <ComboboxOption
//                         key={sizeType.id}
//                         value={sizeType}
//                         className="group relative cursor-default select-none py-2 pl-3 pr-9 text-gray-900 data-[focus]:bg-indigo-600 data-[focus]:text-white"
...
//   //   handleColorChange(variantIndex, color); // Update the color in the variant
//   // }}
//   onChange={(color) => {
