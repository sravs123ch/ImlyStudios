...
const initialPayments = [
  { 
    name: 'Anil', 
    location: '12, 4th Cross Rd, Hegde Nagar, Bengaluru, Karnataka 560077', 
  ...
  { 
    name: 'Peter', 
    location: '7th Main, 2nd Block, Jayanagar, Bengaluru, Karnataka 560041', 
  ...
  { 
    name: 'Arief', 
    location: '15/2, 3rd Floor, MG Road, Bengaluru, Karnataka 560001', 
  ...
  { 
    name: 'Ravi', 
    location: '202, 5th Main Rd, Koramangala, Bengaluru, Karnataka 560034', 
  ...
  { 
    name: 'Ram', 
    location: '10, 1st Floor, Commercial Street, Bengaluru, Karnataka 560001', 
              ...
              <tbody className="divide-y divide-gray-200">
                {payments.map((payment, index) => (
                  <tr key={index}>
                    ...
                    <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{payment.location}</td>
