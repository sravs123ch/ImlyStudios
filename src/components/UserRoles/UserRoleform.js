...
//     const { userRoleDetails } = useContext(RoleContext);

//     const isEditMode = Boolean(location.state?.userRoleDetails?.role || userRoleDetails?.role);

//     const [formData, setFormData] = useState(() => location.state?.userRoleDetails || {
//         RoleID: "",  
//         RoleName: "",
//         Status: "",
//     });
...
//     useEffect(() => {
//         if (isEditMode) {
//             const role = location.state?.userRoleDetails?.role || userRoleDetails?.role;
//             if (role) {
//                 setFormData({
//                     RoleID: role.RoleID || "",
...
//             }
//         }
//     }, [isEditMode, location.state?.userRoleDetails?.role, userRoleDetails?.role]);
...
//                 ? `https://imlystudios-backend-mqg4.onrender.com/api/userrole/updateRole/${formData.RoleID}`
//                 : "https://imlystudios-backend-mqg4.onrender.com/api/userrole/createRole";
...
function UserRoleform() {
    ...
    const handleFormSubmit = async (event) => {
        event.preventDefault();
        try {
            const apiUrl = "https://imlystudios-backend-mqg4.onrender.com/api/userrole/createOrUpdateRole";
